...
# #Dictionary methods
print(student.keys())  #Print dict_obj of list of keys 
print(student.values())  #Print dict_obj of list of values
print(student.items())   #Return dict_obj of list of tuples contain key and its associated values
